...
const invalid_attachment_type_error_1 = require("../../../../domain/parcel-forwarding/application/use-cases/errors/invalid-attachment-type-error");
...
let UploadAttachmentController = class UploadAttachmentController {
    ...
    constructor(uploadAndCreateAttachmentUseCase) {
        this.uploadAndCreateAttachmentUseCase = uploadAndCreateAttachmentUseCase;
    }
    async handle(file) {
