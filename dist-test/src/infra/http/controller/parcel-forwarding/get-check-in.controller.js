...
exports.GetCheckInController = void 0;
...
let GetCheckInController = class GetCheckInController {
    getCheckInUseCase;
    checkInDetailsPresenter;
    constructor(getCheckInUseCase, checkInDetailsPresenter) {
    ...
    async handle(user, checkInId) {
        ...
        const checkInDetails = this.checkInDetailsPresenter.toHTTP(result.value.checkInDetails);
        return {
            checkInDetails,
        };
    }
};
exports.GetCheckInController = GetCheckInController;
__decorate([
    (0, common_1.Get)(),
...
], GetCheckInController.prototype, "handle", null);
exports.GetCheckInController = GetCheckInController = __decorate([
    (0, common_1.Controller)('/check-in/:id'),
    __metadata("design:paramtypes", [get_check_in_1.GetCheckInUseCase,
        check_in_details_presenter_1.CheckInDetailsPresenter])
], GetCheckInController);
//# sourceMappingURL=get-check-in.controller.js.map