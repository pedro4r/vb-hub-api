...
exports.FetchRecentCheckInsDetailsController = void 0;
...
let FetchRecentCheckInsDetailsController = class FetchRecentCheckInsDetailsController {
    fetchRecentCheckInsDetailsUseCase;
    checkInDetailsPresenter;
    constructor(fetchRecentCheckInsDetailsUseCase, checkInDetailsPresenter) {
        this.fetchRecentCheckInsDetailsUseCase = fetchRecentCheckInsDetailsUseCase;
...
exports.FetchRecentCheckInsDetailsController = FetchRecentCheckInsDetailsController;
__decorate([
    (0, common_1.Get)(),
...
], FetchRecentCheckInsDetailsController.prototype, "handle", null);
exports.FetchRecentCheckInsDetailsController = FetchRecentCheckInsDetailsController = __decorate([
    (0, common_1.Controller)('/check-ins-details'),
    __metadata("design:paramtypes", [fetch_recent_check_ins_details_1.FetchRecentCheckInsDetailsUseCase,
        check_in_details_presenter_1.CheckInDetailsPresenter])
], FetchRecentCheckInsDetailsController);
//# sourceMappingURL=fetch-recent-check-ins-details.controller.js.map