...
exports.GetDeclarationModelUseCase = void 0;
...
let GetDeclarationModelUseCase = class GetDeclarationModelUseCase {
    ...
    async execute({ declarationModelId, customerId, }) {
        const declarationModel = await this.declarationModelRepository.findById(declarationModelId);
        if (!declarationModel) {
            return (0, either_1.left)(new resource_not_found_error_1.ResourceNotFoundError('No declaration model found.'));
        }
        ...
        const items = await this.declarationModelItemsRepository.findManyByDeclarationModelId(declarationModelId);
        if (!items) {
            return (0, either_1.left)(new resource_not_found_error_1.ResourceNotFoundError('No declaration model items found.'));
        }
...
exports.GetDeclarationModelUseCase = GetDeclarationModelUseCase;
exports.GetDeclarationModelUseCase = GetDeclarationModelUseCase = __decorate([
...
//# sourceMappingURL=get-declaration-model.js.map