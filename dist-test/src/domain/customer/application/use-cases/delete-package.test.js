...
const delete_package_1 = require("./delete-package");
...
describe('Delete a Package', () => {
    beforeEach(async () => {
        ...
        sut = new delete_package_1.DeletePackageUseCase(inMemoryPackageRepository);
    ...
    it('should be able to delete a package', async () => {
        ...
        const checkIns = await inMemoryCheckInsRepository.findManyByPackageId('package-1');
...
//# sourceMappingURL=delete-package.test.js.map