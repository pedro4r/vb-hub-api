...
describe('Edit Check-in (E2E)', () => {
  ...
  test('[PUT] /check-in/:id', async () => {
    ...
    const response = await request(app.getHttpServer())
      .put(`/check-in/${checkIn.id.toString()}`)
      .set('Cookie', cookie)
      .send({
        ...
        details: 'details',
        weight: '1',
        attachmentsIds: [attachment3.id.toString()],
      })
    ...
    expect(checkInAttachmentOnDatabase).toHaveLength(1)
  })
})
